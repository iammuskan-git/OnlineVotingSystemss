<?php
    ...
    {
 ?>
        <div class="alert alert-success my-3" rele="alert">
...
<?php
    ...
    {
?>
    <div class="alert alert-danger my-3" rele="alert">
                ...
                <?php
                    ...
                    if($isAnyElectionAdded > 0)
                    {
                         while($row = mysqli_fetch_assoc($fetchingElections))
                         {
                            ...
                            //Now checking how any candidates are added in this election
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <?php
                 ...
                 ?>
                    <tr>
                        <td colspan="7">No any candidates is added yet.</td>
                    </tr>
                 <?php
                    }
                ?>
...
if(isset($_POST['addCandidateBtn']))
{
    ...
    $candidate_photo = $targetted_folder . rand(1111111111, 999999999999). "_" . rand(111111111,99999999999). 
    ...
    if($image_size < 2000000)   //2MB
        {
            if(in_array($candidate_photo_type,$allowed_types))
            {
                if(move_uploaded_file($candidate_photo_tmp_name,$candidate_photo))
                {
                    ...
                    candidate_photo,inserted_by,inserted_on) VALUES('".  $election_id  ."','". $candidate_name ."','".  $candidate_details  ."',
                    '". $candidate_photo ."','". $inserted_by ."','". $inserted_on ."')") or
                    die(mysqli_error($db));
