...
?>
		<div class="d-flex justify-content-center form_container">
					<form method="POST">
				 	...
				 	<button type="submit" name="sign_up_btn" class="btn login_btn text-white">Sign Up</button>
				   </div>
					</form>
				</div>                                  
				<div class="mt-4">
		...
		<div class="d-flex justify-content-center form_container">
					<form method="POST">
						<div class="input-group mb-3">
							...
							<input type="text" name="contact_no" min="3" max="3" class="form-control input_user"  placeholder="Contact No" required/>
						</div>
						<div class="input-group mb-2">
							<div class="input-group-append">
								<span class="input-group-text"><i class="fas fa-key"></i></span>
...
if($su_password == $su_retype_password)
{
    ...
    mysqli_query($db, "INSERT INTO users(username, contact_no, password, user_role) VALUES('".$su_username ."', '".$su_contact_no."', '".$su_password."','".$user_role."' )") or die
    (mysqli_error($db));
