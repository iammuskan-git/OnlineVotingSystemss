...
?>
            <table class="table">
                <thead>
                    <tr>
                        <th colspan="4" class="bg-green"><h3>ELECTION TOPIC: <?php  echo strtoupper($election_topic); ?></h3></th>
                    </tr>
                    <tr>
                        <th>Photo</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                        <?php
                            $checkIfVoteCasted = mysqli_query($db, "SELECT *FROM votings WHERE voters_id = '".
                             $_SESSION['user_id'] ."' AND election_id = '". $election_id ."'") 
                            ...
                            if($isVoteCasted > 0)
                            {
                                ...
                                $voteCastedToCandidate = $isVoteCastedData['candidate_id'];
